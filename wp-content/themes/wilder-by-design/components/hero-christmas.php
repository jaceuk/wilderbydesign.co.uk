...
<section class="hero-section christmas">
  <div class="inner-wrapper">
    <div class="title-with-text">
      <p class="pre-text">Don't delay</p>
      <h1 class="super">Order today</h1>
      <p class="sub-text">to get delivery in time for Christmas (UK only)</p>
    </div>
