...
function rude_by_design_scripts() {
	...
	wp_style_add_data( 'rude-by-design-style', 'rtl', 'replace' );

	wp_enqueue_script( 'rude-by-design-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
