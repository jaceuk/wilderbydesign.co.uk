...
if ( ! function_exists( 'base_setup' ) ) :
	...
	function base_setup() {
		...
		register_nav_menus( array(
            'menu-1' => esc_html__( 'Main - column 1', 'base' ),
            'menu-2' => esc_html__( 'Main - column 2', 'base' ),
            'menu-3' => esc_html__( 'Main - column 3', 'base' ),
            'menu-4' => esc_html__( 'Main - column 4', 'base' ),
            'menu-5' => esc_html__( 'Main - column 5', 'base' ),
            'menu-6' => esc_html__( 'Main - column 6', 'base' ),
            'menu-7' => esc_html__( 'Main - column 7', 'base' ),
            'menu-8' => esc_html__( 'Main - column 8', 'base' ),
            'menu-9' => esc_html__( 'Footer', 'base' )
		) );
...
function base_scripts() {
    ...
    wp_enqueue_script( 'base-bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js', array('jquery'), false, true );

    wp_enqueue_script( 'base-js', get_template_directory_uri() . '/js/main.js', array('jquery'), false, true );
}
